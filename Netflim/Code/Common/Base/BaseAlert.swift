...
struct BaseAlert: View {
    ...
    @ViewBuilder func alertTexts() -> some View {
        Text(model.title).font(.subheadline).foregroundStyle(Color.black).multilineTextAlignment(.center)
        Text(model.description).font(.body).foregroundStyle(Color.black)
